package com.loanlassalle.smartcity.database.controllers;
...
public class ConfigurationManager {
    ...
    private final String messageBundlePropertiesFile =
            "com/loanlassalle/smartcity/database/resources/messagesBundles/messageBundle";

    /**
     * Fichier de propriétés utilisé pour définir les paramètres du système de log
     */
    private final String loggingPropertiesFile =
            "com/loanlassalle/smartcity/database/resources/logging.properties";
