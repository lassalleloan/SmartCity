package com.loanlassalle.smartcity.pdf;
...
import com.loanlassalle.smartcity.pdf.graphiques.GenerateurGraphique;
...
public class GenerateurPDF {
    ...
    public static void cree(String nomEvenement, Calendar date) throws Exception {
        ...
        LOGO = GenerateurPDF.class.getClassLoader()
                .getResource("com/loanlassalle/smartcity/pdf/resources/images/logo.png");
